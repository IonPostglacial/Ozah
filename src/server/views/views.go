...
func GetDocumentBranch(ctx context.Context, queries *dataset.Queries, doc *documents.ViewModel, dbName string, makeLink link.Maker) (*breadcrumbs.ViewModel, error) {
	if doc == nil || doc.Path == "" {
